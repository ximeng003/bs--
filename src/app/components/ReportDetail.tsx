...
import { CheckCircle, XCircle, Clock, Download, Share2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <CardContent className="pt-6">
          <div className="flex items-start justify-between mb-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl font-semibold text-gray-900">{reportData.caseName}</h2>
          ...
          <div className="grid grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
            <div className="text-center">
              <div className="text-2xl font-semibold text-gray-900">{reportData.totalSteps}</div>
              <div className="text-sm text-gray-600 mt-1">总步骤数</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-green-600">{reportData.passedSteps}</div>
              <div className="text-sm text-gray-600 mt-1">通过步骤</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-red-600">{reportData.failedSteps}</div>
              <div className="text-sm text-gray-600 mt-1">失败步骤</div>
            </div>
            <div className="text-center">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <Card className="border-gray-200">
          <CardContent className="pt-6">
            <h3 className="font-semibold text-gray-900 mb-4">执行步骤时间线</h3>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-gray-200">
            <CardContent className="pt-6">
              <h3 className="font-semibold text-gray-900 mb-4">控制台日志</h3>
              <div className="bg-gray-900 text-green-400 p-4 rounded font-mono text-xs h-[300px] overflow-y-auto">
          ...
          {/* Error Screenshot */}
          <Card className="border-gray-200 border-red-300">
            <CardContent className="pt-6">
              ...
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded p-8 text-center">
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 mb-2">payment_result.png</p>
